...
<p>The other cookie is purely for convenience, usually called MOODLEID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in"></i>
            ...
            <div class="col-lg-6">
                <h3 class="title">Meet our new e-learning system</h3>
                <div class="accordion" id="accordionExample">
                    <div class="card my-1">
                        <div class="card-header p-0" id="headingOne">
                            <h2 class="m-0">
                                <a class="btn btn-block text-left p-0 overflow-hidden text-uppercase d-flex align-items-center" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <span class="pl-3 font-weight-bold">Login info for students</span>
                                </a>
                            </h2>
                        </div>
                    ...
                    <div class="card my-1">
                        <div class="card-header p-0" id="headingTwo">
                            <h2 class="m-0">
                                <a class="btn btn-block text-left p-0 overflow-hidden text-uppercase d-flex align-items-center" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                    <span class="pl-3 font-weight-bold"> Login info for teachers</span>
                                </a>
                            </h2>
                        </div>
                    ...
                    <div class="card my-1 ">
                        <div class="card-header p-0" id="headingThree">
                            <h2 class="m-0">
                                <a class="btn btn-block text-left p-0 overflow-hidden text-uppercase d-flex align-items-center" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                    <span class="pl-3 font-weight-bold"> Privacy policy</span>
                                </a>
                            </h2>
                        </div>
