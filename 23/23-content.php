...
<div class="type-23">
    <div class="container">
        ...
        <p class="content-title text-muted">Curabitur aliquet quam id dui posuere blandit. Sed porttitor lectus nibh. Pellentesque in ipsum id <br> orci porta dapibus.</p>
        <p class="content-title text-muted">Proin eget tortor risus. Curabitur aliquet quam id dui posuere blandit. Curabitur non nulla sit amet <br> nisl tempus convallis  quis ac lectus. Donec rutrum congue leo eget malesuada.</p>
        <div class="row">
            <div class="col-md-8">
                <div class="row">
